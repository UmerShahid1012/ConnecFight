        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group col-md-6">
                    ...
                    <input id="" type="text" name="o_pass" value="{{$admin->name}}" class="form-control" placeholder="Enter name">
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group col-md-6">
                    ...
                    <input id="" type="text" name="n_pass" value="{{$admin->email}}" class="form-control" placeholder="Enter email">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group col-md-6">
                    <label for="name" class="col-form-label">Confirm Password</label>
                    <input id="" type="text" name="c_pass" value="{{$admin->email}}" class="form-control" placeholder="Enter email">
                </div>
            </div>
