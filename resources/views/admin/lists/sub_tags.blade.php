        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="col-md-12">
                        <a href="{{ route('admin.add.sub.tags',[$id]) }}" type="button"
                           class="btn btn-primary pull-right identity">Add Sub Tag</a>
                    </div>
                            ...
                            @foreach($tags as $u)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.edit.sub.tags', [$u->id]) }}" data-toggle="modal"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h5>Are you sure you want to delete this sub-tag?</h5>
                                                    </div>
                                                    <div class="modal-footer">

                                                        <form action="{{ route('admin.sub.delete', [$u->id]) }}"
                                                              method="post">
                                                            @csrf
