        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="col-md-12">
                        <a href="{{ route('admin.add.event') }}" type="button"
                            ...
                            @foreach($tags as $u)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.edit.event', [$u->id]) }}" data-toggle="modal"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('admin.event.delete', [$u->id]) }}"
                                                              method="post">
                                                            @csrf
